...
var
    ...
    SWIFT_OPTIMIZATION_LEVEL_XCODE = '"' + SWIFT_OPTIMIZATION_LEVEL + '"',
    SWIFT_SWIFT3_OBJC_INFERENCE = 'On',
    SWIFT_SWIFT3_OBJC_INFERENCE_XCODE = '"' + SWIFT_SWIFT3_OBJC_INFERENCE + '"',
    STRIP_SWIFT_SYMBOLS = 'NO',
    STRIP_SWIFT_SYMBOLS_XCODE = '"' + STRIP_SWIFT_SYMBOLS + '"',
...
module.exports = function (context) {
    ...
    swiftOptions.push('SWIFT_OPTIMIZATION_LEVEL = ' + SWIFT_OPTIMIZATION_LEVEL);
    swiftOptions.push('SWIFT_SWIFT3_OBJC_INFERENCE = ' +  SWIFT_SWIFT3_OBJC_INFERENCE);
    swiftOptions.push('STRIP_SWIFT_SYMBOLS = ' + STRIP_SWIFT_SYMBOLS);
	// NOTE: Not needed
	...
	xcodeProject.parse(function (error) {
		...
		Object.keys(configurations).forEach(function (config) {
            ...
            buildSettings.SWIFT_OPTIMIZATION_LEVEL = SWIFT_OPTIMIZATION_LEVEL_XCODE;
            buildSettings.SWIFT_SWIFT3_OBJC_INFERENCE = SWIFT_SWIFT3_OBJC_INFERENCE_XCODE;
            buildSettings.STRIP_SWIFT_SYMBOLS = STRIP_SWIFT_SYMBOLS_XCODE;
		});
