...
class PluginMediaStream : NSObject, RTCMediaStreamDelegate {
	@objc var rtcMediaStream: RTCMediaStream
	@objc var id: String
	@objc var audioTracks: [String : PluginMediaStreamTrack] = [:]
	@objc var videoTracks: [String : PluginMediaStreamTrack] = [:]
	@objc var eventListener: ((_ data: NSDictionary) -> Void)?
	@objc var eventListenerForAddTrack: ((_ pluginMediaStreamTrack: PluginMediaStreamTrack) -> Void)?
	@objc var eventListenerForRemoveTrack: ((_ id: String) -> Void)?


	/**
	 * Constructor for pc.onaddstream event and getUserMedia().
	 */
	@objc init(rtcMediaStream: RTCMediaStream) {
	...
	@objc func getJSON() -> NSDictionary {
	...
	@objc func addTrack(_ pluginMediaStreamTrack: PluginMediaStreamTrack) -> Bool {
	...
	@objc func removeTrack(_ pluginMediaStreamTrack: PluginMediaStreamTrack) -> Bool {
